...
// --- Reusable List Item Component (with fix) ---
...
const SubscriptionListItem: React.FC<SubscriptionListItemProps> = ({ subscription, onClick }) => {
    ...
    return (
        // Use the key on the Card itself if mapping directly, otherwise on the component instance
        <Card className="overflow-hidden">
            {/* Wrap button in CardContent */}
            ...
            <div className="space-y-3">
                 {mockSubscriptionsV1.map((sub) => (
                    <SubscriptionListItem
                        key={sub.id} // Key on the component instance
                        subscription={sub}
